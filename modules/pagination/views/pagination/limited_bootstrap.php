<ul class="pagination pagination-sm">
    ...
    <?php if ($first_page !== FALSE): ?>
        <li>
            <a href="<?php echo $page->url($first_page) ?>"
    ...
    <?php if ($previous_page !== FALSE): ?>
        <li>
            <a href="<?php echo $page->url($previous_page) ?>" rel="prev">
    ...
    if ($offset > 1)
        for ($i = $offset - $left + 1; $i < $offset; $i++):
            ?>
            <li>
                <a href="<?php echo $page->url(abs($i)) ?>">
                    <?php echo abs($i) ?></a>
            </li>
    ...
    <?php if ($next_page !== FALSE): ?>
        <li>
            <a href="<?php echo $page->url($next_page) ?>" rel="next">
                <?php echo __('Next') ?></a>
        </li>
    <?php else: ?>
        <li class="disabled">
    ...
    <?php if ($last_page !== FALSE): ?>
        <li>
            <a href="<?php echo $page->url($last_page) ?>" rel="last">
                <?php echo __('Last') ?></a>
        </li>
    <?php else: ?>
        <li class="disabled">
